...
storiesOf("Listing", module).add("one listing", () => (
  <Listing {...listingProps} />
));

storiesOf("Graph", module)
  .add("loading", () => <Graph isLoading />)
  .add("loaded", () => (
    <Graph
      isLoading={false}
      labels={[
...
const headlines = [
  ...
  {
    title:
      "Shiller: The market is experiencing 'irrational exuberance aaaaaaaaaaaaaaaaaaaaaa",
    link: "/article2"
  },
  {
...
storiesOf("News", module).add("default", () => (
  <Router>
...
storiesOf("Stock", module).add("default", () => (
  <Router>
    <Stock />
  </Router>
));

storiesOf("Trade", module).add("default", () => (
